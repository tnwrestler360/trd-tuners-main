...
local function toggleMenuContainer(state, image)
    SendNUIMessage({
...
function InitiateMenus(isMotorcycle, vehicleHealth, categories, welcomeLabel)
    ...
    if vehicleHealth < 1000.0 and categories.repair then
        ...
        TriggerServerEvent("script-customs:server:updateRepairCost", repairCost)
...
function DisplayMenuContainer(state, image)
    toggleMenuContainer(state, image)
end
...
function ScrollFunctionality(direction)
    SendNUIMessage({
        scrollFunctionality2 = true,
        direction = direction
    })
end

function DisplayMenu2(state, slider1, slider2, slider3, slider4, slider5, slider6, slider7, slider8, slider9, startPos)
    if state then
            ...
            {
                {
                    ...
                    items = 
                    {
                        ...
                        {name = "w_wfl", type_1 = "normal", label_1 = "Wheel Front Left Rotation", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider6, sliderStartPos = startPos[6]},
                        {name = "w_wfr", type_1 = "normal", label_1 = "Wheel Front Right Rotation", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider7, sliderStartPos = startPos[7]},
                        {name = "w_wrl", type_1 = "normal", label_1 = "Wheel Rear Left Rotation", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider8, sliderStartPos = startPos[8]},
                        {name = "w_wrr", type_1 = "normal", label_1 = "Wheel Rear Right Rotation", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider9, sliderStartPos = startPos[9]}
                    }
                },
                {
