...
Config.LocationsFitment = {
    ['WheelFitment'] = { -- do not touch here PLEASE
        settings = {
            ...
            welcomeLabel = "Welcome to 6STR Tuner Shop!",
            timer = 10000,
            enabled = true,
        },
        drawtextui = {
        ...
        zones = {
            { coords = vector3(145.23, -3044.17, 7.04), length = 6.0, width = 4.0, heading = 360.0, minZ = 6.04, maxZ = 9.64 },
        }
    },
}
...
Config.Locations = {
    ['Innocence'] = {
        ...
        zones = {
            { coords = vector3(-207.09, -1320.18, 31.0), length = 6.0, width = 4.0, heading = 180.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-216.11, -1322.86, 31.0), length = 6.0, width = 4.0, heading = 180.0, minZ = 29.88, maxZ = 33.48 },
        }
    },
    ['Popular'] = {
        settings = {
            image = 'customs',
            label = 'Los Santos Customs Motorworks',
    ...
    ['Hayes'] = {
        settings = {
            ...
            welcomeLabel = "Welcome to Hayes Auto Body Shop!",
            enabled = true,
        },
        blip = {
            label = 'Hayes Auto Body Shop',
    ...
    ['6STR'] = {
        settings = {
            image = '6str',
            label = '6STR Tuner Shop',
            welcomeLabel = "Welcome to the 6STR Tuner Shop!",
            enabled = true,
        },
        blip = {
            label = '6STR Tuner Shop',
