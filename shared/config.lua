...
Config.AdminMenu = true -- Set false if you are not using qb-adminmenu ## https://github.com/qbcore-framework/qb-adminmenu ## OR IF YOU WANT TRIGGER ONLY ADMIN USE WEEHLFITMENT PUT THIS ON THE TRIGGER "qb-admin:client:ToggleDevmode"
